...
```
## Mortality rate in 2020 (per 100.000 population)
```{r}
...
ggplot(esp_prov) +
  ...
  scale_fill_gradientn(
   ...
   labs(      # labels and tittles
    title = "Mortality rate in Spain (per 100.000 population)",
...
```
## "Mortality rate in Spain (per 100.000 population) in January 2020
```{r}
...
ggplot(esp_prov) +
  ...
  scale_fill_gradientn(
   ...
   labs(    # lables and titles
    title = "Mortality rate in Spain (per 100.000 population) in January 2020",
    subtitle = "INE Data (2020)"
  ) +
  geom_sf(data = can_prov) +
  geom_sf(data = Can) +
...
```
## Mortality rate in Spain (per 100.000 population) in April 2020
```{r}
...
ggplot(esp_prov) +
  ...
  scale_fill_gradientn(
   ...
   labs(    # lables and titles
    title = "Mortality rate in Spain (per 100.000 population) in April 2020",
    subtitle = "INE Data (2020)"
  ) +
  geom_sf(data = can_prov) +
  geom_sf(data = Can) +
...
```{r}
ccaa_mort <-read.csv("~/Desktop/estadistica/statistics2/CCAA_DR_Mortality_Population.csv")
...
ggplot(CCAA) +
  ...
  scale_fill_gradientn(
   ...
   labs(    # lables and titles
    title = "Mortality rate in Spain (per 100.000 population) in 2020 per A.C.",
    subtitle = "INE Data (2020)"
  ) +
  geom_sf(data = can_prov) +
  geom_sf(data = Can) +
