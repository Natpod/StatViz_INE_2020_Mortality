---
title: "Barplots for crude mortality rates and rates per 100,000 inhabitants in Spain 2020"
...
ggsave(filename = "figures/mortality_month.svg", width = 15, height = 5, device='svg', dpi=700)
```
...
ggsave(filename = "figures/mortality_pmonth_sex.svg", width = 15, height = 5, device='svg', dpi=700)
```
...
monthsex <- ggplot(data = df, mapping = aes(x=Month,y=Deaths))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 12),
        ...
        axis.title=element_text(size=12))
monthsex
ggsave(filename = "figures/mortality_distribution_month.svg", width = 15, height = 5, device='svg', dpi=700)
```
...
monthsex
ggsave(filename = "figures/mortality_distribution_province.svg", width = 20, height = 5, device='svg', dpi=700)
```
...
monthccaa <- ggplot(data = datatotal_ordered, mapping = aes(x=group,y=Deaths))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 11),
        ...
        axis.title=element_text(size=12))
monthccaa
ggsave(filename = "figures/mortality_sum_province.svg", width = 16, height = 7, device='svg', dpi=700)
```
...
monthccaa <- ggplot(data = datatotal_ordered, mapping = aes(x=group,y=Deaths))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 11),
        ...
        axis.title=element_text(size=10))
monthccaa
ggsave(filename = "figures/mortality_distribution_ccaa.svg", width = 15, height = 5, device='svg', dpi=700)
```
...
monthccaa <- ggplot(data = datatotal_ordered, mapping = aes(x=group,y=Deaths))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 11),
        ...
        axis.title=element_text(size=12))
monthccaa
ggsave(filename = "figures/mortality_sum_ccaa.svg", width = 16, height = 7, device='svg', dpi=700)
```
...
ggsave(filename = "figures/deathR_month.svg", width = 15, height = 5, device='svg', dpi=700)
```
...
ggsave(filename = "figures/deathR_pmonth_sex.svg", width = 15, height = 5, device='svg', dpi=700)
```
...
monthsex <- ggplot(data = df, mapping = aes(x=Month,y=DeathRate))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 12),
        ...
        axis.title=element_text(size=9))
monthsex
ggsave(filename = "figures/deathR_distribution_month.svg", width = 15, height = 5, device='svg', dpi=700)
```
## 4. Plotting by province with ordered medians
```{r sbs39}
...
monthsex <- ggplot(data = datatotal_ordered, mapping = aes(x=group,y=DeathRate))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 11),
        ...
        axis.title=element_text(size=9))
monthsex
ggsave(filename = "figures/deathR_distribution_province.svg", width = 20, height = 5, device='svg', dpi=700)
```
...
dataDRplot$DR <- ( dataDRplot$sum.Total / dataDRplot$pob19 ) * 100000
...
monthccaa <- ggplot(data = datatotal_ordered, mapping = aes(x=group,y=DeathRate))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 11),
        ...
        axis.title=element_text(size=12))
monthccaa
ggsave(filename = "figures/deathR_sum_province.svg", width = 16, height = 7, device='svg', dpi=700)
```
## 5. Grouping by Autonomic Community
...
monthccaa <- ggplot(data = datatotal_ordered, mapping = aes(x=group,y=DeathRate))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 11),
        ...
        axis.title=element_text(size=9))
monthccaa
ggsave(filename = "figures/deathR_distribution_ccaa.svg", width = 15, height = 5, device='svg', dpi=700)
```
```{r sbs88}
...
monthccaa <- ggplot(data = datatotal_ordered, mapping = aes(x=group,y=DeathRate))+
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1, size = 11),
        ...
        axis.title=element_text(size=12))
monthccaa
ggsave(filename = "figures/deathR_sum_ccaa.svg", width = 16, height = 7, device='svg', dpi=700)
```
```{r sbs77}
